...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    message: 'This stimulus appeared in the same position as 2 trials ago (top-left). Press the A key or tap the Position button to indicate a match!',
    waitForKey: 'position',
    highlight: 'buttons',
  },
  {
  ...
  },
  {
    ...
    phase: 'during',
    title: 'Audio Match!',
    message: 'The letter "D" was also played 2 trials ago! Press the L key or tap Audio to mark the audio match.',
    waitForKey: 'audio',
    highlight: 'buttons',
  },
  {
